...
$source = $_GET['source'] ?? ''; // Check for a source parameter
$deposit = null;
    ...
    <div class="page-container">
        <div class="profile-card">
            ...
            <div style="margin-top: 20px;">
                ...
                <?php else: ?>
                    <a href="edit_money_deposit.php?id=<?php echo $deposit['id']; ?>" class="btn" style="display: inline-block; width: auto; margin-right: 10px;" title="Edit"><i class="fas fa-edit"></i></a>
                    <a href="download_money_deposit.php?id=<?php echo $deposit['id']; ?>" class="btn" style="display: inline-block; width: auto; margin-right: 10px; background-color: #218838;" title="Download"><i class="fas fa-download"></i></a>
                    <a href="delete_money_deposit.php?id=<?php echo $deposit['id']; ?>" class="btn" style="display: inline-block; width: auto; margin-right: 10px; background-color: #dc3545;" onclick="return confirm('Are you sure you want to delete this deposit?');" title="Delete"><i class="fas fa-trash-alt"></i></a>
                    <a href="view_money.php" class="btn" style="display: inline-block; width: auto; background-color: #6c757d;" title="Back to Deposits"><i class="fas fa-arrow-left"></i></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
