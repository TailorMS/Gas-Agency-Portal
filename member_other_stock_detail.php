    ...
    <div class="page-container">
        <div class="content-card">
            ...
            <?php elseif($stock): ?>
                ...
                <div class="detail-item" style="background-color: #e7f3ff;"><strong>Total Quantity:</strong><span><?php echo htmlspecialchars($stock['total_quantity']); ?></span></div>
                <div class="action-bar" style="margin-top: 20px;">
                    <a href="edit_member_other_stock.php?id=<?php echo $stock['id']; ?>" class="btn" title="Edit"><i class="fas fa-edit"></i></a>
                    <a href="download_member_other_stock.php?id=<?php echo $stock['id']; ?>" class="btn" style="background-color: #218838;" title="Download"><i class="fas fa-download"></i></a>
                    <a href="delete_member_other_stock.php?id=<?php echo $stock['id']; ?>" class="btn" style="background-color: #dc3545;" onclick="return confirm('Are you sure you want to delete this stock record?');" title="Delete"><i class="fas fa-trash-alt"></i></a>
                    <a href="member_view_other_stock.php" class="btn" style="background-color: #6c757d;" title="Back to Stock List"><i class="fas fa-arrow-left"></i></a>
                </div>
            <?php endif; ?>
        </div>
    </div>
