        ...
        if ($stmt = $mysqli->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                ...
                if ($stmt->num_rows == 1) {
                    ...
                    $update_sql = "UPDATE members SET reset_token = ?, reset_token_expires_at = ? WHERE email = ?";
                    if ($update_stmt = $mysqli->prepare($update_sql)) {
                        ...
                        $message = "A password reset link has been generated. In a real application, this would be emailed. For now, please use this link: <br><a href='{$reset_link}'>{$reset_link}</a>";
                        // ------------------------------------
                    }
                } else {
...
<body>
    <div class="login-container">
        ...
        <?php endif; ?>
        <p style="margin-top: 15px;"><a href="member_login.php">Back to Login</a></p>
    </div>
</body>
</html>