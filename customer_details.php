    ...
    <div class="page-container">
        ...
        <div class="profile-card">
            ...
            <div style="margin-top: 20px;">
                <a href="edit_customer.php?id=<?php echo htmlspecialchars($id); ?>" class="btn" style="display: inline-block; width: auto; margin-right: 10px;" title="Edit"><i class="fas fa-edit"></i></a>
                <a href="download_customer.php?id=<?php echo htmlspecialchars($id); ?>" class="btn" style="display: inline-block; width: auto; margin-right: 10px; background-color: #218838;" title="Download"><i class="fas fa-download"></i></a>
                <a href="delete_customer.php?id=<?php echo htmlspecialchars($id); ?>" class="btn" style="display: inline-block; width: auto; margin-right: 10px; background-color: #dc3545;" onclick="return confirm('Are you sure you want to delete this customer?');" title="Delete"><i class="fas fa-trash-alt"></i></a>
                <a href="view_customers.php" class="btn" style="display: inline-block; width: auto; background-color: #6c757d;" title="Back to Customers"><i class="fas fa-arrow-left"></i></a>
            </div>
        </div>
    </div>
