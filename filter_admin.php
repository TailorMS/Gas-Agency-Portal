...
<body>
    ...
    <div class="page-container">
        <div class="content-card">
            ...
            <form action="view_transaction.php" method="get" class="profile-card" style="max-width: 100%;">
                ...
                <div style="display: flex; gap: 10px; margin-top: 20px; flex-wrap: wrap;">
                    ...
                    <a href="view_transaction.php" class="btn" style="background-color: #ffc107; color: #212529; flex-grow: 1;"><i class="fas fa-undo"></i> Reset Filters</a>
                    <a href="view_transaction.php?<?php echo $query_params; ?>" class="btn" style="background-color: #6c757d; flex-grow: 1;"><i class="fas fa-arrow-left"></i> Back</a>
                </div>
            </form>
        </div>
    </div>
